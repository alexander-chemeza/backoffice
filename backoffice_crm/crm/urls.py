...
urlpatterns = [
    ...
    path('products-list/', TemplateView.as_view(template_name='crm/products/products-list.html'),),
    ...
    path('leads-list/', TemplateView.as_view(template_name='crm/leads/leads-list.html'),),
    ...
    path('customers-list/', TemplateView.as_view(template_name='crm/customers/customers-list.html'),),
    ...
    path('contracts-list/', TemplateView.as_view(template_name='crm/contracts/contracts-list.html'),),
